...
public class TileManager {
	...
	public void getTileImage() {
		...
		try {
			...
			tile[6] = new Tile();
			tile[6].image = ImageIO.read(getClass().getResourceAsStream("/tiles/wall_1.png"));
	...
	public void resetTiles(int map) {

	    // reload base tiles state for new level
	    try {
	    	switch (map){
	    	case 0:
		        tile[0].image = ImageIO.read(getClass().getResourceAsStream("/tiles/bg_1.png"));
	    	...
	    	case 1:
		        tile[0].image = ImageIO.read(getClass().getResourceAsStream("/tiles/bg_2.png"));

		        tile[1].image = ImageIO.read(getClass().getResourceAsStream("/tiles/wall_2.png"));
		        tile[1].collision = 1;

		        tile[2].image = ImageIO.read(getClass().getResourceAsStream("/tiles/stairs_2.png"));
		        tile[2].collision = 2;

		        tile[3].image = ImageIO.read(getClass().getResourceAsStream("/tiles/rope_2.png"));
		        tile[3].collision = 3;

		        tile[4].image = ImageIO.read(getClass().getResourceAsStream("/tiles/wall_2.png"));
		        tile[4].collision = 1;
		        tile[4].isDestructible = true;

		        tile[5].image = ImageIO.read(getClass().getResourceAsStream("/tiles/stairs_2.png"));
		        tile[5].collision = 2;
	    		break;
	    		
	    	case 2:
		        tile[0].image = ImageIO.read(getClass().getResourceAsStream("/tiles/bg_3.png"));

		        tile[1].image = ImageIO.read(getClass().getResourceAsStream("/tiles/wall_3.png"));
		        tile[1].collision = 1;

		        tile[2].image = ImageIO.read(getClass().getResourceAsStream("/tiles/stairs_3.png"));
		        tile[2].collision = 2;

		        tile[3].image = ImageIO.read(getClass().getResourceAsStream("/tiles/rope_3.png"));
		        tile[3].collision = 3;

		        tile[4].image = ImageIO.read(getClass().getResourceAsStream("/tiles/wall_3.png"));
		        tile[4].collision = 1;
		        tile[4].isDestructible = true;

		        tile[5].image = ImageIO.read(getClass().getResourceAsStream("/tiles/stairs_3.png"));
		        tile[5].collision = 2;
	    		break;
	    	}
	    ...
	    // reload map data
	    loadMap(mapLocation.getMap(map), map);
	}
